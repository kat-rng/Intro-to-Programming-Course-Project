function showHelp(button)
    ...
    content = [
        ...
        "This function will only operate if any beams already exist. Click on this button to set the material for all beams present on the graph. This will overwrite any individual materials that have already been preset. This will not set the material of any future beams that are added. Once in the window, select the desired material. Click the (Save) option to apply this material. Click on (Cancel) to cancel.";
