function showHelp(button)
    ...
    % Help Text
    titles = ["Note: "; "Add Points:"; "Remove Points: "; "Edit Point: "; "Add Beams: "; "Remove Beams: "; "Edit Beam: "; "Start Simulation: "; "Stop Simulation and Edit: "; "Reset Program: ";];
    content = [
        ...
        "Click on this button to enable the ability to delete points on the graph. This will delete all beams that are connected to the point upon deletion. Click the button before clicking on a point to cancel the operation.";
